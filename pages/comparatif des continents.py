...
# Charger les données
chart = pd.read_csv("SuicideMonde1990-2022.csv")  # Assurez-vous de remplacer "votre_fichier.csv" par le nom de votre fichier de données

# Titre de l'application
st.title("Taux de suicides annuels en Europe")
...
# Filtrage des données en fonction de la plage de dates sélectionnée et de la région
...
st.title("Taux de suicides annuels en Amerique Centrale et Amerique du Sud")
